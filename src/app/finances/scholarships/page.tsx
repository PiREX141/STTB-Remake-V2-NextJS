  ...
  const scholarships = [
    {
      ...
      description:
        "Awarded based on academic excellence and GPA. Renewable annually with maintained academic standing.",
    },
    {
      title: "Ministry Leadership Scholarship",
      amount: "Up to 40% tuition",
      description:
        "For students with demonstrated leadership in church ministry or Christian service.",
    },
    {
      title: "Financial Need Grant",
      amount: "Varies",
      description:
        "Need-based assistance for students with demonstrated financial hardship. Application required.",
    },
    {
      title: "International Student Grant",
      amount: "IDR 5,000,000/year",
      description:
        "Support for international students pursuing theological studies at STTB.",
    },
  ];
        ...
        <div className="container mx-auto max-w-screen-xl px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 mb-12 text-center">
              STTB is committed to making theological education accessible. We
              offer various scholarship and financial aid opportunities to
              qualified students.
            </p>
