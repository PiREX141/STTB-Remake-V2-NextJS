        ...
        <div className="container mx-auto max-w-screen px-4">
          <div className="max-w-4xl mx-auto flex flex-col gap-5">
            ...
            <div className="bg-white p-12 rounded-2xl">
              ...
              {[
                {
                  question: "Apakah STTB menyediakan beasiswa?",
                  answer:
                ...
                {
                  question: "Berapa biaya studi di STTB?",
                  answer:
                ...
                {
                  question: "Apakah saya dapat bekerja sambil kuliah?",
                  answer:
                    "Bila Anda mengambil studi di program Sarjana atau M.Th. Matrikulasi, bekerja tidaklah memungkinkan karena jadwal kuliah yang padat dan adanya batasan waktu untuk meninggalkan lingkungan asrama.\n\n Bila Anda mengambil studi di program Magister Teologi (M.Th.) atau Magister Pendidikan Kristen (M.Pd.) atau Magister Ministri Pelayanan Marketplace(M.Min.) yang memiliki sistem kuliah block teaching maka Anda dapat bekerja/melayani sambil studi.",
                },
                {
                  question: "Apakah saya harus tinggal di asrama?",
                  answer:
