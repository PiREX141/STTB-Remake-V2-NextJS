        ...
        <div className="container mx-auto max-w-screen-xl px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-sttb-dark-blue mb-2">
                          Address
                        </h3>
            ...
            <div>
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl text-sttb-dark-blue">
                    Send Us a Message
                  </CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  {submitted ? (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                      ...
                      <p className="text-gray-700">
                        Your message has been sent. We&apos;ll respond within
                        1-2 business days.
                      </p>
                    </div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <Button
                        type="submit"
                        className="w-full bg-sttb-accent-red hover:bg-sttb-accent-red/90 cursor-pointer"
                      >
                        Send Message
                      </Button>
                    </form>
